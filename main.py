...
/skills - добавьте область вашего проекта.🎀
/projects - просмотрите все свои проекты и его подробности!👑
/delete - удалите свой проект, который стал не нужен.📕
/update_projects - обновите свой проект.:-)
...
def name_project(message):
    ...
    if unique_name != name:
        bot.send_message(message.chat.id, f"Проект переименован в: {unique_name}")
